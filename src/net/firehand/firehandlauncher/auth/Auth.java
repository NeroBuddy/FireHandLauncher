...
import net.firehand.firehandlauncher.auth.exceptions.InvalidCredentialsException;
import net.firehand.firehandlauncher.auth.exceptions.RequestException;
import net.firehand.firehandlauncher.auth.exceptions.UserMigratedException;
...
import net.firehand.firehandlauncher.auth.responses.LoginResponse;
import net.firehand.firehandlauncher.auth.responses.RequestResponse;
import net.firehand.firehandlauncher.utils.JsonUtils;
